...
// Add a trial plan if it doesn't exist
$CI = &get_instance();
...
// Init data
$CI->db->where('type', 'trial');
$trial_plan = $CI->db->get(db_prefix() . 'uplicrm_website_builder_service_plans')->row();
if (!$trial_plan) {
    $CI->db->insert(db_prefix() . 'uplicrm_website_builder_service_plans', [
        'name' => 'Trial Plan',
        'description' => 'A trial plan for new users.',
        'price' => 0,
        'type' => 'trial',
